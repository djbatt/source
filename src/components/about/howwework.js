...
import { Grow, ChatOption, Plan, Code } from "grommet-icons"
    ...
    <Box>
      ...
      <Box width="large">
        <Paragraph color="text" fill>
          At Source we like to work with clients who have a specific goal. Our
          process ensures that nothing gets lost in the details.
        </Paragraph>
      </Box>
      <ul
        css={`
