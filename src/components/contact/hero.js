...
export default () => {
  const data = useStaticQuery(graphql`
    query {
      file(relativePath: { eq: "stephen-poore-GNPd2_JBCoM-unsplash.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 2000) {
          ...
          <Container>
            <Box pad="large">
              ...
              <Box width="large">
                ...
                We're taking on new clients right now and want to hear about your project. We're always available to chat. Reach out to us anytime. 
                </Paragraph>
              </Box>
            </Box>
          </Container>
